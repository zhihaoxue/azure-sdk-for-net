...
namespace Azure.Learn.AppConfig.Tests
{
    public class ConfigurationClientLiveTests : RecordedTestBase<LearnAppConfigTestEnvironment>
    {
        ...
        public ConfigurationClientLiveTests(bool isAsync) :
        ...
        public async Task GetSetting()
        {
            ...
            // Note: if you have many tests that assert the equality of two settings,
            // it is good practice to factor out into a helper method or define
